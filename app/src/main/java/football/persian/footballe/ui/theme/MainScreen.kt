package football.persian.footballe.ui
...
import football.persian.footballe.R
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            val buttonGradient = if (isDarkMode) {
                listOf(Color(0xD3D32E2E), Color(0xD870363C)) // نارنجی - زرد برای حالت دارک
            } else {
...
fun ToggleThemeButton(isDarkMode: Boolean, onToggle: () -> Unit) {
    ...
    IconButton(
        ...
        modifier = Modifier
            .size(48.dp)
            .background(
                color = if (isDarkMode) Color(0xFFA73334) else Color(0xFF274C65),
