    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            val buttonGradient = if (isDarkMode) {
                listOf(Color(0xFFFF5722), Color(0xFFFFC107)) // نارنجی - زرد برای حالت دارک
            } else {
                listOf(Color(0xFF1976D2), Color(0xFF42A5F5)) // آبی تیره - آبی روشن برای حالت لایت
            }
...
fun ToggleThemeButton(isDarkMode: Boolean, onToggle: () -> Unit) {
    ...
    IconButton(
        ...
        modifier = Modifier
            .size(48.dp)
            .background(
                color = if (isDarkMode) Color(0x99FFEB3B) else Color(0xAB42A5F5),
